	...
	<form action="../public/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		<div class="columns">
			<div class="column">
				<div class="control">
		...
		<div class="columns">
			...
			<div class = "column">
				<div class="control">
					...
					<?php $fcha = date("Y-m-d");?>
					<input type="date" class="input" name="fecha_exp" value="<?php echo $fcha;?>" >		
				</div>
			</div>
		</div>
		<div class="columns">
