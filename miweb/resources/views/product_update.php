	...
	<form action="../public/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
			...
			<div class="column">
				<div class="control">
					...
					<?php $fcha = date("Y-m-d");?>
					<input type="date" class="input"  value="<?php echo $datos['fecha_exp']; ?>" >
				</div>
			</div>
		</div>
