...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<form class="FormularioAjax" action="../public/producto_img_eliminar.php" method="POST" autocomplete="off" >
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="../public/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
	...
	<?php 
			...
			include "../public/error_alert.php";
		}
		$check_producto=null;
	?>
</div>